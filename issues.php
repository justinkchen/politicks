...
<?php
	...
	while ($row = mysql_fetch_array($result)){
		...
		$output .= "<li data-icon='false'><a href=\"solution.php?issue_id=".$_GET['id']."&politician_id=".$politician_row["id"]."\">".$row["solution"]."<p class='politicianName'>".$politician_row["name"]."</p></a></li>";
	}
	if(mysql_num_rows($result) == 0){
